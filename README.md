...
### Installazione
Attualmente il programma è progettato per girare su sistemi OSX, presto verrà integrato il supporto per Windows.
...
```bash
gcc main.c algebra.c menumatrix.c menusystem.c -o main
```
